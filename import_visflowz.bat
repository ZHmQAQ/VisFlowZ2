...
title VModule - Import VisFlowZ Config

cd /d "%~dp0"
set "BASE_DIR=%~dp0"
set "BACKEND_DIR=%BASE_DIR%backend"
set "SCRIPT=%BASE_DIR%scripts\import_visflowz.py"
set "CONDA_BAT="

echo ============================================
echo   VModule - Import VisFlowZ Config
echo ============================================
echo.
...
echo.
if "!RC!"=="0" (
    echo   ===^> Import OK. All self-checks passed.
) else if "!RC!"=="2" (
    echo   ===^> Import OK with WARN. Manual review recommended.
) else (
